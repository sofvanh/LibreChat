...
function WorkspaceSelect() {
  ...
  const { selectedWorkspaceId, handleWorkspaceSelect } = workspace;
  ...
  }, [isWorkspaceSelected, handleWorkspaceSelect]);
    ...
    <div className="flex">
      <button
        ...
        className={cn(
          ...
          'rounded-r-none border-r-0 hover:shadow-md',
        )}
      >
        {/* Icon */}
              ...
              workspaces.map((workspace) => (
                <Ariakit.MenuItem
                  ...
                  className={cn(
                    ...
                    workspace._id === selectedWorkspaceId && 'bg-black/[0.1] dark:bg-white/[0.15]',
                  )}
                >
